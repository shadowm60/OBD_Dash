...
#endif
#define LVGL_PORT_TICK_PERIOD_MS    (CONFIG_BSW_LVGL_PORT_TICK)

/**
 * LVGL timer handle task related parameters, can be adjusted by users
 *
 */
#define LVGL_PORT_TASK_MAX_DELAY_MS (CONFIG_BSW_LVGL_PORT_TASK_MAX_DELAY_MS)    // The maximum delay of the LVGL timer task, in milliseconds
#define LVGL_PORT_TASK_MIN_DELAY_MS (CONFIG_BSW_LVGL_PORT_TASK_MIN_DELAY_MS)    // The minimum delay of the LVGL timer task, in milliseconds
#define LVGL_PORT_TASK_STACK_SIZE   (CONFIG_BSW_LVGL_PORT_TASK_STACK_SIZE_KB * 1024) // The stack size of the LVGL timer task, in bytes
#define LVGL_PORT_TASK_PRIORITY     (CONFIG_BSW_LVGL_PORT_TASK_PRIORITY)        // The priority of the LVGL timer task
#define LVGL_PORT_TASK_CORE         (CONFIG_BSW_LVGL_PORT_TASK_CORE)            // The core of the LVGL timer task,
 ...
 *
 */
#if CONFIG_BSW_LVGL_PORT_BUF_PSRAM
#define LVGL_PORT_BUFFER_MALLOC_CAPS    (MALLOC_CAP_SPIRAM)
#elif CONFIG_BSW_LVGL_PORT_BUF_INTERNAL
#define LVGL_PORT_BUFFER_MALLOC_CAPS    (MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT | MALLOC_CAP_DMA)
#endif
#define LVGL_PORT_BUFFER_HEIGHT         (CONFIG_BSW_LVGL_PORT_BUF_HEIGHT)

/**
 * Avoid tering related configurations, can be adjusted by users.
 *
 */
#define LVGL_PORT_AVOID_TEAR_ENABLE     (CONFIG_BSW_LVGL_PORT_AVOID_TEAR_ENABLE) // Set to 1 to enable
 ...
 *
 */
#define LVGL_PORT_AVOID_TEAR_MODE       (CONFIG_BSW_LVGL_PORT_AVOID_TEAR_MODE)
 ...
 *
 */
#define BSW_LVGL_PORT_ROTATION_DEGREE  (CONFIG_BSW_LVGL_PORT_ROTATION_DEGREE)
...
#define BSW_LVGL_PORT_ROTATION_0    (1)
#else
#if BSW_LVGL_PORT_ROTATION_DEGREE == 90
#define BSW_LVGL_PORT_ROTATION_90   (1)
#elif BSW_LVGL_PORT_ROTATION_DEGREE == 180
#define BSW_LVGL_PORT_ROTATION_180  (1)
#elif BSW_LVGL_PORT_ROTATION_DEGREE == 270
#define BSW_LVGL_PORT_ROTATION_270  (1)
#endif
